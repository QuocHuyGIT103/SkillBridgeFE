      ...
      <div className="w-full max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden lg:flex flex-col justify-center space-y-8 px-12">
            <NavLink
              to="/"
              className="inline-flex items-center bg-gradient-to-r from-orange-600 to-orange-700 text-white px-6 py-3 rounded-2xl shadow-lg text-xl font-bold gap-3 hover:shadow-xl transition-shadow duration-200 w-fit"
            >
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Đừng lo lắng! Việc quên mật khẩu là điều hoàn toàn bình thường.
                Chúng tôi sẽ giúp bạn lấy lại quyền truy cập nhanh chóng và an
                toàn.
              </p>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Nhận mã OTP</h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Hoàn tất</h3>
                    <p className="text-sm text-gray-600">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl border-0 p-8">
            ...
            <div className="lg:hidden text-center mb-6">
              <NavLink
                to="/"
                className="inline-flex items-center bg-gradient-to-r from-orange-600 to-orange-700 text-white px-6 py-3 rounded-2xl shadow-lg text-xl font-bold gap-3 hover:shadow-xl transition-shadow duration-200"
              >
                <div className="bg-white/20 p-1 rounded-lg">
                  <svg
                    className="w-6 h-6"
