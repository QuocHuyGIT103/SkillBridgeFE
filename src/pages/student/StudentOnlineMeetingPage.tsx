...
/**
 * Student Online Meeting Page
 * Embeds Jitsi meeting with auto tracking
 */
const StudentOnlineMeetingPage: React.FC = () => {
  ...
  const fetchMeetingInfo = async () => {
    try {
      ...
      const studentName = classResponse.data?.studentId?.full_name || 'Học viên';

      setMeetingInfo({
        meetingLink: canJoinResponse.meetingLink || '',
        displayName: `${studentName} (Học viên)`,
      });
...
export default StudentOnlineMeetingPage;
