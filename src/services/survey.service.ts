...
class SurveyService {
  ...
  ): Promise<ApiResponse<SurveySubmitResponse>> {
    try {
  ...
  static async getSurvey(): Promise<ApiResponse<SurveySubmitResponse>> {
    try {
      const response = await axiosClient.get<SurveySubmitResponse>(
        "/ai/survey"
      );
      return response;
    } catch (error: any) {
  ...
  static async getSurveyStatus(): Promise<ApiResponse<SurveyStatusResponse>> {
    try {
      const response = await axiosClient.get<SurveyStatusResponse>(
        "/ai/survey/status"
      );
      return response;
    } catch (error: any) {
