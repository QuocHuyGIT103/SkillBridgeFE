      ...
      <div className="p-4 pt-12 flex flex-col flex-grow">
        ...
        <div className="flex items-start space-x-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {tutor.headline && (
              <p className={`text-xs line-clamp-1 ${isTopMatch ? 'text-gray-700 font-medium' : 'text-gray-600'}`}>
                {tutor.headline}
              </p>
            )}
            {showRating && (
        ...
        <div className="space-y-2.5 mb-3 flex-grow">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-2 border border-blue-100">
            <div className="flex items-center gap-1.5 mb-1.5">
              ...
              <span className="text-xs font-semibold text-blue-700 uppercase tracking-wide">Môn dạy</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-lg p-2 border border-emerald-100">
              <div className="flex items-center gap-1 mb-0.5">
                ...
                <span className="text-xs font-medium text-emerald-600">Học phí</span>
              </div>
              <p className="text-sm font-bold text-emerald-700">{formatPrice(tutorPost.pricePerSession)}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-2 border border-amber-100">
              <div className="flex items-center gap-1 mb-0.5">
                ...
                <span className="text-xs font-medium text-amber-600">Thời lượng</span>
              </div>
              <p className="text-sm font-bold text-amber-700">{tutorPost.sessionDuration} phút</p>
            </div>
          </div>
        ...
        <div className={`border-t pt-2 mt-auto ${isTopMatch ? 'border-gray-200' : 'border-gray-100'}`}>
          <div className="flex flex-wrap gap-1">
        ...
        <div className="mt-3 flex gap-2">
          ...
          <button
            ...
            className={`${user?.role?.toUpperCase() === 'STUDENT' ? 'flex-1' : 'w-full'} inline-flex items-center justify-center gap-1.5 px-3 py-2 
